...
public class UIOutline : MaskableGraphic
{
    ...
    {
        get => _outlineWidth;
        set { _outlineWidth = value; SetVerticesDirty(); }
    }
    ...
    {
        get => _cornerSegments;
        set { _cornerSegments = value; SetVerticesDirty(); }
    }

    public float MappingBias
    {
        get => _mappingBias;
        set { _mappingBias = value; SetVerticesDirty(); }
    }

    public bool FillCenter
    {
        get => _fillCenter;
        set { _fillCenter = value; SetVerticesDirty(); }
    }
